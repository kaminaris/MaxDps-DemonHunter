...
function Havoc:callaction()
    ...
    fury_gen = (talents[classtable.DemonBlades] and talents[classtable.DemonBlades] or 0)*(1%(2.6 * SpellHaste)*((talents[classtable.Demonsurge] and buff[classtable.MetamorphosisBuff].up)*3 + 12))+buff[classtable.ImmolationAuraBuff].count * 6+buff[classtable.TacticalRetreatBuff].upMath * 10
    trinket_pacemaker_proc = MaxDps:CheckTrinketNames('ImprovisedSeaforiumPacemaker') and trinket.1.stat.crit.up or MaxDps:CheckTrinketNames('ImprovisedSeaforiumPacemaker') and trinket.2.stat.crit.up or not MaxDps:CheckEquipped('ImprovisedSeaforiumPacemaker')
