...
function Havoc:ar()
    ...
    if (MaxDps:CheckSpellUsable(classtable.VengefulRetreat, 'VengefulRetreat')) and (talents[classtable.Initiative] and (cooldown[classtable.EyeBeam].remains >15 and gcd <0.3 or gcd <0.2 and cooldown[classtable.EyeBeam].remains <= gcd and cooldown[classtable.Metamorphosis].remains >10) and (not trinket1_steroids and not trinket2_steroids or trinket1_steroids and true and MaxDps:HasOnUseEffect('13') and (MaxDps:CheckTrinketCooldown('13').remains <gcd*3 or MaxDps:CheckTrinketCooldown('13').remains >30) or trinket2_steroids and true and MaxDps:HasOnUseEffect('13') and (MaxDps:CheckTrinketCooldown('14').remains <gcd*3 or MaxDps:CheckTrinketCooldown('13').remains >30)) and timeInCombat >20 and (not talents[classtable.Inertia] and not buff[classtable.UnboundChaosBuff].up or not buff[classtable.InertiaTriggerBuff].up and not buff[classtable.MetamorphosisBuff].up)) and cooldown[classtable.VengefulRetreat].ready then
...
function Havoc:ar_cooldown()
    ...
    if (MaxDps:CheckSpellUsable(classtable.mad_queens_mandate, 'mad_queens_mandate')) and (((not talents[classtable.Initiative] or buff[classtable.InitiativeBuff].up or timeInCombat >5) and (buff[classtable.MetamorphosisBuff].remains >5 or not buff[classtable.MetamorphosisBuff].up) and (MaxDps:CheckTrinketNames('MadQueensMandate') and (MaxDps:CheckTrinketCooldown('14').duration <10 or MaxDps:CheckTrinketCooldown('14').remains >10 or not MaxDps:HasBuffEffect('14', 'any')) or MaxDps:CheckTrinketNames('MadQueensMandate') and (MaxDps:CheckTrinketCooldown('13').duration <10 or MaxDps:CheckTrinketCooldown('13').remains >10 or not MaxDps:HasBuffEffect('13', 'any'))) and ttd >120 or MaxDps:boss() and ttd <10 and ttd <buff[classtable.MetamorphosisBuff].remains) and not debuff[classtable.EssenceBreakDeBuff].up or ttd <5) and cooldown[classtable.mad_queens_mandate].ready then
        MaxDps:GlowCooldown(classtable.mad_queens_mandate, cooldown[classtable.mad_queens_mandate].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.treacherous_transmitter, 'treacherous_transmitter')) and (not MaxDps:CheckEquipped('MadQueensMandate') or MaxDps:CheckEquipped('MadQueensMandate') and (MaxDps:CheckTrinketNames('MadQueensMandate') and MaxDps:CheckTrinketCooldown('13').remains >ttd or MaxDps:CheckTrinketNames('MadQueensMandate') and MaxDps:CheckTrinketCooldown('14').remains >ttd) or ttd >25) and cooldown[classtable.treacherous_transmitter].ready then
        MaxDps:GlowCooldown(classtable.treacherous_transmitter, cooldown[classtable.treacherous_transmitter].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.skardyns_grace, 'skardyns_grace')) and ((not MaxDps:CheckEquipped('MadQueensMandate') or ttd >25 or MaxDps:CheckTrinketNames('SkardynsGrace') and MaxDps:CheckTrinketCooldown('13').remains >ttd or MaxDps:CheckTrinketNames('SkardynsGrace') and MaxDps:CheckTrinketCooldown('14').remains >ttd or MaxDps:CheckTrinketCooldown('13').duration <10 or MaxDps:CheckTrinketCooldown('14').duration <10) and buff[classtable.MetamorphosisBuff].up) and cooldown[classtable.skardyns_grace].ready then
    ...
    if (MaxDps:CheckSpellUsable(classtable.ravenous_honey_buzzer, 'ravenous_honey_buzzer')) and ((tier33_4piece and (not buff[classtable.InertiaBuff].up and (not cooldown[classtable.EssenceBreak].ready and not debuff[classtable.EssenceBreakDeBuff].up or not talents[classtable.EssenceBreak])) and (MaxDps:CheckTrinketNames('RavenousHoneyBuzzer') and (MaxDps:CheckTrinketCooldown('14').duration <10 or MaxDps:CheckTrinketCooldown('14').remains >10 or not MaxDps:HasBuffEffect('14', 'any')) or MaxDps:CheckTrinketNames('RavenousHoneyBuzzer') and (MaxDps:CheckTrinketCooldown('13').duration <10 or MaxDps:CheckTrinketCooldown('13').remains >10 or not MaxDps:HasBuffEffect('13', 'any'))) and ttd >120 or MaxDps:boss() and ttd <10 and ttd <buff[classtable.MetamorphosisBuff].remains) or ttd <5) and cooldown[classtable.ravenous_honey_buzzer].ready then
        MaxDps:GlowCooldown(classtable.ravenous_honey_buzzer, cooldown[classtable.ravenous_honey_buzzer].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket1, 'trinket1')) and (((cooldown[classtable.EyeBeam].remains <gcd and targets >1 or buff[classtable.MetamorphosisBuff].up) and (math.huge >MaxDps:CheckTrinketCooldown('13').duration-15 or targets >8) or not MaxDps:HasBuffEffect('13', 'any') or MaxDps:boss() and ttd <25) and not MaxDps:CheckTrinketNames('MisterLocknstalk') and not trinket1_crit and not MaxDps:CheckTrinketNames('SkardynsGrace') and not MaxDps:CheckTrinketNames('TreacherousTransmitter') and (not special_trinket or MaxDps:CheckTrinketCooldown('14').remains >20)) and cooldown[classtable.trinket1].ready then
        MaxDps:GlowCooldown(classtable.trinket1, cooldown[classtable.trinket1].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket2, 'trinket2')) and (((cooldown[classtable.EyeBeam].remains <gcd and targets >1 or buff[classtable.MetamorphosisBuff].up) and (math.huge >MaxDps:CheckTrinketCooldown('14').duration-15 or targets >8) or not MaxDps:HasBuffEffect('14', 'any') or MaxDps:boss() and ttd <25) and not MaxDps:CheckTrinketNames('MisterLocknstalk') and not trinket2_crit and not MaxDps:CheckTrinketNames('SkardynsGrace') and not MaxDps:CheckTrinketNames('TreacherousTransmitter') and (not special_trinket or MaxDps:CheckTrinketCooldown('13').remains >20)) and cooldown[classtable.trinket2].ready then
...
function Havoc:fs_cooldown()
    ...
    if (MaxDps:CheckSpellUsable(classtable.trinket1, 'trinket1')) and (((cooldown[classtable.EyeBeam].remains <gcd and targets >1 or buff[classtable.MetamorphosisBuff].up) and (math.huge >MaxDps:CheckTrinketCooldown('13').duration-15 or targets >8) or not MaxDps:HasBuffEffect('13', 'any') or MaxDps:boss() and ttd <25) and not MaxDps:CheckTrinketNames('SkardynsGrace') and not MaxDps:CheckTrinketNames('MadQueensMandate') and not MaxDps:CheckTrinketNames('TreacherousTransmitter') and (not special_trinket or MaxDps:CheckTrinketCooldown('14').remains >20)) and cooldown[classtable.trinket1].ready then
        MaxDps:GlowCooldown(classtable.trinket1, cooldown[classtable.trinket1].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket2, 'trinket2')) and (((cooldown[classtable.EyeBeam].remains <gcd and targets >1 or buff[classtable.MetamorphosisBuff].up) and (math.huge >MaxDps:CheckTrinketCooldown('14').duration-15 or targets >8) or not MaxDps:HasBuffEffect('14', 'any') or MaxDps:boss() and ttd <25) and not MaxDps:CheckTrinketNames('SkardynsGrace') and not MaxDps:CheckTrinketNames('MadQueensMandate') and not MaxDps:CheckTrinketNames('TreacherousTransmitter') and (not special_trinket or MaxDps:CheckTrinketCooldown('13').remains >20)) and cooldown[classtable.trinket2].ready then
        MaxDps:GlowCooldown(classtable.trinket2, cooldown[classtable.trinket2].ready)
    end
...
function Havoc:callaction()
    ...
    double_on_use = not MaxDps:CheckEquipped('SignetofthePriory') and not MaxDps:CheckEquipped('HouseofCards') or (MaxDps:CheckTrinketNames('HouseofCards') or MaxDps:CheckTrinketNames('SignetofthePriory')) and MaxDps:CheckTrinketCooldown('13').remains >20 or (MaxDps:CheckTrinketNames('HouseofCards') or MaxDps:CheckTrinketNames('SignetofthePriory')) and MaxDps:CheckTrinketCooldown('14').remains >20
